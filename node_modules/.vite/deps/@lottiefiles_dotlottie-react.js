  ...
  if (typeof Response == `function` && e5 instanceof Response) {
    if (typeof WebAssembly.instantiateStreaming == `function`)
      try {
        ...
        if (e5.headers.get(`Content-Type`) != `application/wasm`)
...
async function P(e5) {
  if (f !== void 0)
    return f;
  if (e5 !== void 0 && (Object.getPrototypeOf(e5) === Object.prototype ? { module_or_path: e5 } = e5 : console.warn(`using deprecated parameters for the initialization function; pass a single object instead`)), e5 === void 0)
...
function G(e5) {
  ...
  if (t2 instanceof HTMLCanvasElement) {
    ...
    if (n3.width === 0 || n3.height === 0 || t2.width === 0 || t2.height === 0)
      return null;
...
async function K(e5) {
  ...
  if (!t2.ok)
    throw Error(`Failed to fetch image slot source from URL: ${e5}. ${t2.status}: ${t2.statusText}`);
...
function ae(e5, t2, n3) {
  ...
  async function o3(t3) {
    ...
    if (!n4.ok)
      throw Error(`fetch ${t3} responded with ${n4.status} ${n4.statusText}`);
...
var se = class {
  ...
  async _fetchData(e5) {
    let t2 = await fetch(e5);
    if (!t2.ok)
      throw Error(`Failed to fetch animation data from URL: ${e5}. ${t2.status}: ${t2.statusText}`);
  ...
  get layout() {
    if (this._dotLottieCore)
      return { align: [this._dotLottieCore.layout_align_x(), this._dotLottieCore.layout_align_y()], fit: oe(this._dotLottieCore.layout_fit()) };
  }
  get marker() {
    var _a;
  ...
  get manifest() {
    ...
    try {
      ...
      if (this._dotLottieCore === null || !e5)
        return null;
  ...
  _draw() {
    ...
    if (!(i3 !== null && i3.width === t2 && i3.height === n3 && i3.data.byteLength === r3 && this._cachedImageDataBuffer === e5.buffer && this._cachedImageDataByteOffset === e5.byteOffset)) {
      if (typeof ImageData > `u`)
        this._cachedImageData = this._context.createImageData(t2, n3);
      else {
  ...
  play() {
    if (this._dotLottieCore === null || !this.isLoaded)
      return;
    this._stopAnimationLoop();
  ...
  setBackgroundColor(e5) {
    if (this._dotLottieCore !== null) {
      if (s && this._canvas instanceof HTMLCanvasElement)
        this._canvas.style.backgroundColor = e5;
      else {
  ...
  destroy() {
    ...
    if (this._dotLottieCore = null, this._context = null, e5)
      try {
        e5.free();
      } catch (e6) {
  ...
  static async registerFont(e5, t2) {
    try {
      ...
      if (typeof t2 == `string`) {
        ...
        if (!e6.ok)
          return console.error(`Failed to fetch font from URL: ${t2}. Status: ${e6.status}`), false;
        n3 = new Uint8Array(await e6.arrayBuffer());
      } else
        n3 = t2 instanceof Uint8Array ? t2 : new Uint8Array(t2);
      let r3 = re(e5, n3);
...
function Z(e5, t2) {
  if (typeof HTMLCanvasElement < `u` && e5 instanceof HTMLCanvasElement) {
    ...
    if (n3 !== 0 && r3 !== 0)
      return { width: r3 * t2, height: n3 * t2 };
  }
...
var $ = class e4 {
  constructor(t2) {
    ...
    if (r(this, `_eventManager`, new F()), r(this, `_id`, void 0), r(this, `_worker`, void 0), r(this, `_canvas`, void 0), r(this, `_dotLottieInstanceState`, { loopCount: 0, markers: [], autoplay: false, backgroundColor: ``, currentFrame: 0, duration: 0, loop: false, mode: `forward`, segment: [0, 0], speed: 1, totalFrames: 0, isLoaded: false, isPlaying: false, isPaused: false, isStopped: true, isFrozen: false, useFrameInterpolation: false, renderConfig: { devicePixelRatio: U() }, activeAnimationId: ``, activeThemeId: ``, layout: void 0, marker: ``, isReady: false, manifest: null }), r(this, `_created`, false), r(this, `_boundOnClick`, null), r(this, `_boundOnPointerUp`, null), r(this, `_boundOnPointerDown`, null), r(this, `_boundOnPointerMove`, null), r(this, `_boundOnPointerEnter`, null), r(this, `_boundOnPointerLeave`, null), r(this, `_pendingConfig`, null), t2.canvas) {
      ...
      if (!e5 && !n4)
        throw Error(`Worker-based DotLottie requires HTMLCanvasElement or OffscreenCanvas`);
    }
  ...
  async _create(e5) {
    ...
    if (n3 !== this._id)
      throw Error(`Instance ID mismatch`);
  ...
  async setCanvas(e5) {
    ...
    if (this._canvas !== e5) {
      if (this._created && this._canvas !== null)
        throw Error(`Cannot change canvas after worker instance is already created with a different canvas.`);
  ...
  async getSlotType(e5) {
    if (this._created)
      return this._sendMessage(`getSlotType`, { instanceId: this._id, slotId: e5 });
  }
  async getSlot(e5) {
    if (this._created)
      return this._sendMessage(`getSlot`, { instanceId: this._id, slotId: e5 });
  }
  async getSlots() {
  ...
  async stateMachineGetNumericInput(e5) {
    if (this._created)
      return this._sendMessage(`stateMachineGetNumericInput`, { instanceId: this._id, name: e5 });
  }
  async stateMachineGetBooleanInput(e5) {
    if (this._created)
      return this._sendMessage(`stateMachineGetBooleanInput`, { instanceId: this._id, name: e5 });
  }
  async stateMachineGetStringInput(e5) {
    if (this._created)
      return this._sendMessage(`stateMachineGetStringInput`, { instanceId: this._id, name: e5 });
  }
  ...
  async stateMachinePostClickEvent(e5, t2) {
    if (this._created)
      return this._sendMessage(`stateMachinePostClickEvent`, { instanceId: this._id, x: e5, y: t2 });
  }
  async stateMachinePostPointerUpEvent(e5, t2) {
    if (this._created)
      return this._sendMessage(`stateMachinePostPointerUpEvent`, { instanceId: this._id, x: e5, y: t2 });
  }
  async stateMachinePostPointerDownEvent(e5, t2) {
    if (this._created)
      return this._sendMessage(`stateMachinePostPointerDownEvent`, { instanceId: this._id, x: e5, y: t2 });
  }
  async stateMachinePostPointerMoveEvent(e5, t2) {
    if (this._created)
      return this._sendMessage(`stateMachinePostPointerMoveEvent`, { instanceId: this._id, x: e5, y: t2 });
  }
  async stateMachinePostPointerEnterEvent(e5, t2) {
    if (this._created)
      return this._sendMessage(`stateMachinePostPointerEnterEvent`, { instanceId: this._id, x: e5, y: t2 });
  }
  async stateMachinePostPointerExitEvent(e5, t2) {
    if (this._created)
      return this._sendMessage(`stateMachinePostPointerExitEvent`, { instanceId: this._id, x: e5, y: t2 });
  }
  _onClick(e5) {
    let t2 = G(e5);
